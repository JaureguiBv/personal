...
<body>
    ...
    <form method="POST">
        ...
        <input type="text" name="apellidos" id="ape" onchange="validarApellido()" required value="<?= isset($paciente) ? $paciente['apellidos'] : '' ?>">

        <label>Primer Nombre:</label>
        <input type="text" name="primerNombre" id="nom" onchange="validarNombre()" required value="<?= isset($paciente) ? $paciente['primerNombre'] : '' ?>">
    ...
    <script src="assets/valNombre.js"></script>
    <script src="assets/valApellido.js"></script>
</body>
</html>
